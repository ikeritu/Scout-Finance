...
DEFAULT_STAGE1_CONFIG = {
    ...
    "min_market_cap_pass": 300_000_000,
    "min_market_cap_watchlist": 100_000_000,
    "min_price_pass": 3.0,
    "min_price_watchlist": 1.0,
    "min_dollar_volume_pass": 2_000_000,
    "min_dollar_volume_watchlist": 500_000,
...
def classify_stage1_row(
    ...
    if price is None:
        ...
        _add_reason(
            reasons,
            reason_code="PRICE_WATCHLIST_RANGE",
