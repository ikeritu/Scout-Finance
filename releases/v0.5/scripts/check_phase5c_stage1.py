"""
Scout Finance — Phase 5C Stage 1 checker.

Run from project root:

    ./.venv/Scripts/python.exe scripts/check_phase5c_stage1.py
...
PASSED = PROJECT_ROOT / "data" / "stages" / "stage1_passed.csv"
WATCHLIST = PROJECT_ROOT / "data" / "stages" / "stage1_watchlist.csv"
REJECTED = PROJECT_ROOT / "data" / "stages" / "stage1_rejected.csv"
REJECTION_LOG = PROJECT_ROOT / "data" / "stages" / "stage1_rejection_log.csv"
SUMMARY = PROJECT_ROOT / "outputs" / "scouting" / "stage1_summary.json"
...
def main() -> int:
    print("Scout Finance — Phase 5C Stage 1 checker")
    print("=" * 54)
    ...
    ok("Stage 1 outputs are consistent")
    ...
    print("XYZ should normally be REJECTED because it is too small/illiquid")
