...
**v2.38BB — piloto real de Cboe Europe, 36% de acierto**: de las 21.066 filas del hueco más grande del proyecto, ~48% son ETFs (fuera de alcance) y 589 ya estaban cubiertas, dejando 9.634 candidatas reales sin ISIN/país/sector. Piloto de 75 empresas (semilla fija) vía búsqueda GLEIF sin filtro de país: dos bugs reales corregidos en vivo (orden de normalización de puntuación, formas jurídicas completas no reconocidas) subieron el acierto de 28% a **36% resuelto, 5,3% ambiguo, 58,7% sin resolver** — números estables. Proyección a las 9.634: ~3.468 resueltas. La decisión de escalar a la población completa queda explícitamente pendiente del usuario.
