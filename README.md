...
**v2.38Z — Irlanda**: mismo método Xetra/ISIN aplicado a los 17 activos de Euronext Dublin — **17/17 identidades resueltas** (Ryanair, Medtronic, Accenture, ICON, Linde, Aon, Johnson Controls y 10 más). La CRO irlandesa no tiene API REST documentado públicamente, pero sí un Open Data Portal oficial (CC BY 4.0, sin credencial) — **8/17 perfiles de registro confirmados**, y una comprobación en vivo confirmó que el 100% de las cuentas depositadas en Irlanda son PDF: **ninguna empresa irlandesa tiene fundamentales reales extraíbles por esta vía**, un límite más definitivo que en GB. Ninguna fase de este rango calcula scoring adicional, ranking, recomendaciones ni autoriza fase 9C.
