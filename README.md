...
- Historial completo, cierre por cierre (v2.33D1 a v2.38T), en `CHANGELOG.md`.
- Extensión global: **9A cerrada; 9B en curso (v2.38C–T cerradas, hasta scoring experimental US y paquete de revisión manual de fundamentales de Europa); 9C no autorizada**. Este rango (v2.38K–T) vive en el branch `phase9b-global-enrichment-v2-38b` (subido a GitHub, **no fusionado a `main`**). Estado: `outputs/full_universe_source_acquisition/v2_38b_global_enrichment/PHASE9B_EXECUTION_STATUS_v2_38b.md`. El ranking de la app sigue limitado a 50 activos, es experimental y no está validado históricamente.
