...
- Progreso histórico: **8/8 fases originales cerradas**; extensión global **9A cerrada / 9B en curso (v2.38C–U cerradas: scoring experimental US + shortlist + contexto macro, y fundación de fundamentales de Europa hasta el gate de disposición para ejecución, con 0 de 3 rutas listas) / 9C no autorizada**. Rango v2.38K–U no fusionado a `main`.
