...
- Progreso histórico: **8/8 fases originales cerradas**; extensión global **9A cerrada / 9B en curso (v2.38C–V cerradas: scoring experimental US + shortlist + contexto macro, y fundamentales de Europa hasta el primer piloto real -- 4/40 identidades GB resueltas, Companies House listo pero bloqueado por credencial) / 9C no autorizada**. Rango v2.38K–V no fusionado a `main`.
