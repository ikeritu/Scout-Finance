...
- Progreso histórico: **8/8 fases originales cerradas**; extensión global **9A cerrada / 9B en curso (v2.38C–Y cerradas: scoring experimental US + shortlist + contexto macro, primeros fundamentales reales de Europa -- 1 empresa (Softcat) con 14/14 conceptos IFRS extraídos y contablemente verificados -- y su matriz de candidatos, 1 fila parcial por falta de precio real; corrección post-X el mismo día: identidad GB real 40/40 vía fuente Xetra, 2 errores de identidad encontrados y corregidos con transparencia; v2.38Y ampliando Companies House/iXBRL a esa escala real: 29/40 perfiles confirmados, 2 empresas con iXBRL real y verificado -- Softcat y Kingfisher) / 9C no autorizada**. Rango v2.38K–Y + corrección no fusionado a `main`.
