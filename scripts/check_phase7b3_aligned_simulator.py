...
"""
Scout Finance — Phase 7B.3 aligned simulator checker.
...
def main() -> int:
    print("Scout Finance — Phase 7B.3 aligned simulator checker")
    print("=" * 74)
    ...
    if report.get("phase") != "7B.3":
        fail(f"Report phase is not 7B.3: {report.get('phase')}")
        return 1
    ok("Report phase is 7B.3")
    ...
    print("Result")
    print("-" * 74)
    ok("Phase 7B.3 aligned simulator is valid")
    return 0
