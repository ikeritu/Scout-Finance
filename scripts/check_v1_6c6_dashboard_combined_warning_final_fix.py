...
def main():
    ...
    print("Scout Finance — v1.6C6 Dashboard Combined Warning Final Fix checker")
    print("="*92)
    ...
    for marker in [
        ...
        "_sf16c6_combined_dashboard_message",
    ...
    req("v1.6C6 dashboard combined warning final fix compatible" in src_text, "combined_scoring_v1.py contains v1.6C6 marker")
    ...
    print("Result")
    print("-"*92)
    print("OK   v1.6C6 Dashboard Combined Warning Final Fix is valid")
