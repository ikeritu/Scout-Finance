...
def main() -> int:
    print("Scout Finance — Phase 7E.1 v0.7 release checkpoint checker")
    print("=" * 92)
    ...
    if summary.get("phase") != "7E.1":
        fail(f"Summary phase is not 7E.1: {summary.get('phase')}")
        return 1
    ok("Summary phase is 7E.1")
    ...
    print("Result")
    print("-" * 92)
    ok("Phase 7E.1 v0.7 release checkpoint is valid")
    return 0
